...
// R, G, B, A
    ...
    public LessonTwoRenderer(FloorModel floorModel) {
        this();
    ...
    FloorWallsOverlay wallsOverlay;
...
//		venueModelOpenGLES2DrawingClass = new VenueModelOpenGLES2DrawingClass(venue);
        wallsOverlay = new FloorWallsOverlay(floorModel, true);
    }
...
//        drawCube();
    ...
    private void drawCube() {
        wallsOverlay.draw(mViewMatrix, mModelMatrix, mProjectionMatrix, mMVPMatrix);
//        for (MyGeneralOpenGLES2DrawingClass item : venueModelOpenGLES2DrawingClass.triangleDraw) {
//
//        }
//        for (MyGeneralOpenGLES2DrawingClass item : venueModelOpenGLES2DrawingClass.coordsPerVertex) {
...
//            GLES20.glDrawElements(GLES20.GL_TRIANGLE_STRIP, 36, GLES20.GL_UNSIGNED_SHORT, item.drawListBuffer);
////			break;
//        }
